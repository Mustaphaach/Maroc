const data = [
    ...
    },
    {
        ...
        title:'Agadir',
        title2:'Oufla',
        description:'Agadir, situated along Morocco s southern coast, is renowned for its stunning beaches, vibrant culture, and rich history. With its mild climate and beautiful coastline, it is a popular destination for tourists seeking relaxation and adventure alike. The city also offers a glimpse into Morocco s past, with remnants of ancient fortifications and traditional markets blending seamlessly with modern amenities. Whether you are exploring historic landmarks, indulging in local cuisine, or simply soaking up the sun, Agadir promises a memorable and enchanting experience.',
    ...
    {
        place:'Rabat',
        title:'Moroccos Historic',
        title2:'Capital',
        description:'Rabat, the capital city of Morocco, is a captivating blend of history, culture, and contemporary life. With its ancient medina, picturesque Kasbah des Oudaias, and well-preserved historic monuments, Rabat offers a glimpse into Moroccos rich past. At the same time, it is a bustling modern metropolis, boasting modern infrastructure, vibrant markets, and a thriving arts scene. As the political and administrative center of the country, Rabat exudes an atmosphere of significance and dynamism, making it a fascinating destination for travelers seeking to explore Moroccos diverse heritage and vibrant present.',
    ...
    },
    {
        ...
        title:'Gateway to',
        title2:'the Sahara',
        description:'Ouarzazate, known as the "Gateway to the Sahara," is a captivating desert city famed for its stunning landscapes and historic kasbahs, such as Ait Ben Haddou. Renowned as the "Hollywood of the Desert," it has been the backdrop for numerous blockbuster films and TV series, attracting visitors with its cinematic allure and authentic Moroccan charm.',
    ...
    },
    {
        ...
        title:'Cultural ',
        title2:'Heartbeat',
        description:'Fes, spiritual and cultural capital, enchants visitors with its labyrinthine medina, ancient mosques, and vibrant souks, such as Bab Boujloud. As one of the world oldest continuously inhabited medieval cities, Fes offers a timeless experience steeped in history and tradition.',
